...
[Coherent compact red interface and in-panel Settings](https://github.com/Grape9113/Resume/issues/15) supersedes the prior presentation and separate-window Settings exception. The approved [visual reference](design/resume-ui-reference.jpg) defines the red shell, centered artwork, transport and speed/Chapters composition, and open-book menu-bar icon. All modes, including Connection and recovery/error states, share the design. Command-comma opens Settings in the same panel; Escape returns to Player without visible Settings/back chrome. Unchanged playback, synchronization and Search contracts remain authoritative. Execution: [#16](https://github.com/Grape9113/Resume/issues/16), [#17](https://github.com/Grape9113/Resume/issues/17), [#18](https://github.com/Grape9113/Resume/issues/18).
