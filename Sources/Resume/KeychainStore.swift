...
actor KeychainStore: CredentialVault {
    ...
    func loadConnection() throws -> StoredCredentials? { try get(StoredCredentials.self, account: "connection") }
    func loadCredentials() throws -> StoredCredentials? { try loadConnection() }
    func loadTokens() throws -> AuthenticationTokens? { try get(AuthenticationTokens.self, account: "tokens") }
    ...
    func saveSelectedLibrary(_ id: String) { UserDefaults.standard.set(id, forKey: "selectedLibrary") }
