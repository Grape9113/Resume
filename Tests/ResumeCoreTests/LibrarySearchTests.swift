...
struct LibrarySearchTests {
    private let books = [
        Audiobook(id: "rangers", title: "Ranger's Apprentice", authors: ["John Flanagan"], series: ["Ranger's Apprentice"], lastPlayedAt: nil),
        Audiobook(id: "hobbit", title: "The Hobbit", authors: ["J. R. R. Tolkien"], series: ["Middle-earth"], lastPlayedAt: Date(timeIntervalSince1970: 200)),
        Audiobook(id: "history", title: "A History of Denmark", authors: ["Knud J. V. Jespersen"], series: [], lastPlayedAt: Date(timeIntervalSince1970: 300)),
    ]
    ...
    func recencyOnlyBreaksTies() {
        let similar = [
            Audiobook(id: "old", title: "Dune", authors: ["Frank Herbert"], series: [], lastPlayedAt: Date(timeIntervalSince1970: 100)),
            Audiobook(id: "new", title: "Dune", authors: ["Frank Herbert"], series: [], lastPlayedAt: Date(timeIntervalSince1970: 200)),
        ]
