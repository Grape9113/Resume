...
4. Open Resume from the menu bar, then open Settings using the gear or Command-comma to see the version, build number, and build time. The newest build has the latest build time.
