...
4. Open Resume from the menu bar, then open Settings using Command-comma to see the version, build number, and build time. Press Escape to return to Player. The newest build has the latest build time.
